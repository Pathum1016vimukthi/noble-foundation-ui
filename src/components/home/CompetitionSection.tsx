...
const SecondPlaceIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className="w-24 h-24 mx-auto mb-4 drop-shadow-xl hover:scale-110 transition-transform duration-300">
    ...
    <g strokeLinecap="round">
      <path d="M 35 75 Q 15 50 25 15" fill="none" stroke="#94A3B8" strokeWidth="3"/>
      <path d="M 65 75 Q 85 50 75 15" fill="none" stroke="#94A3B8" strokeWidth="3"/>
    </g>
...
const ThirdPlaceIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className="w-24 h-24 mx-auto mb-4 drop-shadow-xl hover:scale-110 transition-transform duration-300">
    ...
    <ellipse cx="50" cy="92" rx="30" ry="3" fill="#000000" opacity="0.1"/>
    <g strokeLinecap="round">
      <path d="M 35 75 Q 15 50 25 15" fill="none" stroke="#78350F" strokeWidth="3"/>
      <path d="M 65 75 Q 85 50 75 15" fill="none" stroke="#78350F" strokeWidth="3"/>
    </g>
...
const CompetitionSection = () => (
  <section id="competition" className="section-padding bg-card">
    <div className="max-w-7xl mx-auto">
      ...
      <h3 className="text-2xl text-charcoal text-center mb-12">Prizes</h3>
      
      {/* Prize Podium - Stable Version */}
